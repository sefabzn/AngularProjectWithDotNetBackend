...
const routes: Routes = [
  ...
  {path:"telefondamardizayn/getbytelefongeneldizaynid/:GenelDizaynId",component:TelefonDamarDizaynComponent},
  ...
  {path:"yangindamardizayn/getbyyangingeneldizaynid/:GenelDizaynId",component:YanginDamarDizaynComponent},
